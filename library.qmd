...
My reference library is publicly available on [Zotero](https://www.zotero.org/kathsherratt/library).

Below is a collection of some of my favourite papers.

::: {.callout-info title="Favourites" collapse="true"}
```{r, results='asis'}
